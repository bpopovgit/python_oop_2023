...
class Tournament:
    ...
    def play(self, team_name_1: str, team_name_2: str):
        team1 = next((t for t in self.teams if t.name == team_name_1), None)
        team2 = next((t for t in self.teams if t.name == team_name_2), None)
